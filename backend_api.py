...
# Combined Rankings
print("\nCombined Final Rankings (1-8):")
print(f"1. Champion: {champion}")
print(f"2. Second Place: {second}")
print(f"3. Third Place: {third}")
print(f"4. Fourth Place: {fourth}")
print(f"5. Fifth Place: {champion_bottom}")
print(f"6. Sixth Place: {second_bottom}")
print(f"7. Seventh Place: {third_bottom}")
print(f"8. Eighth Place: {fourth_bottom}")
